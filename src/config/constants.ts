...
export const EDITION_ADDRESS: string = '0x31F90F18Cd93F11fC347362e9f8850E90176d4e5'; // ** NFT CARD ADDRESS
export const CARD_MARKETPLACE: string = '0xdB279BfEDD88fB3d0aabfD5dd6adfea3C558bc6a'; // ** CARD MARKETPLACE ADDRESS
