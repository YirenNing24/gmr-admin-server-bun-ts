 ...
 * 
 * @interface Contracts
 * @property {string} beatsAddress - The address of the Beats contract.
 * @property {string} gmrAddress - The address of the GMR contract.
 * @property {string} cardAddress - The address of the Card contract.
